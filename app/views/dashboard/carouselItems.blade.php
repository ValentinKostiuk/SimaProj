...
<h3 class="dashboard-carousel-items-heading">All Carousel Items <span><a class = "add-new-item-link" href="{{{action('CarouselManagementController@createCarouselItemGet')}}}">add new +</a></span></h3>
